                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: GlassContainer(
                      ...
                      blur: 16,
                      opacity: 0.08,
                      borderColor: AppColors.greenBiomass.withValues(alpha: 0.3),
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.verified_user_rounded, color: AppColors.greenBiomass, size: 20),
                          ),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    const Icon(Icons.circle, color: AppColors.greenBiomass, size: 8),
                                  ],
                                ),
                                Text(
                                  'O₂ prom: 6.4 mg/L • pH 7.2 • Sin alertas críticas',
